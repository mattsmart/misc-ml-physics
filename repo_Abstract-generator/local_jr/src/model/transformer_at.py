...
from model.layers import PositionwiseFeedForward, Generator, clones\
                        , EncoderLayer, DecoderLayer, Embeddings
from model.encdec import Encoder, Decoder, EncoderDecoder


def make_illustrated_model(src_vocab, tgt_vocab, N=6,
